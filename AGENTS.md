...
- Container tasks run Claude Code via API key (`agent-box/skills/abox-live/claude-container-auth.sh`), never `claude /login` subscription — see CLAUDE.md § Container Task Execution
